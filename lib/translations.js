...
export const translations = {
  en: {
    ...
    products: {
      ...
      sectionSubtitle: 'Industrial coatings in multiple sizes — 1 ML, 3 ML, 4 ML, 5 ML, 6 ML and more. Click any card for full details.',
  ...
  ar: {
    ...
    products: {
      ...
      sectionSubtitle: 'طلاءات صناعية بأحجام متعددة — 1 مل، 3 مل، 4 مل، 5 مل، 6 مل والمزيد. انقر على أي بطاقة للتفاصيل.',
      ...
      coverage: 'التغطية',
      dryTime: 'وقت الجفاف',
      recoatWindow: 'فترة إعادة الطلاء',
      base: 'القاعدة',
      sectionSize: '{{size}} مل',
      prev: 'السابق',
      next: 'التالي',
      industrialGrade: 'صناعي',
      variantPartOf: 'جزء من مجموعة {{size}} مل الصناعية.',
      viewFullDetails: 'عرض المنتج الكامل',
    },
    buckets: {
      sectionTitle: 'مجموعات دلاء الطلاء',
      sectionSubtitle: 'نقدم الطلاء الصناعي بأحجام دلاء متعددة تناسب كل حجم مشروع.',
      small: 'دلاء صغيرة',
      smallDesc: 'مثالية لللمسات والعينات والمشاريع الصغيرة.',
      medium: 'دلاء متوسطة',
      mediumDesc: 'للورش والصيانة والطلاء للمساحات المتوسطة.',
      large: 'دلاء كبيرة',
      largeDesc: 'حجم مشروع وحجم صناعي.',
    },
    contact: {
