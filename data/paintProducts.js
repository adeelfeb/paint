...
export const PAINT_PRODUCTS = [
  ...
  /**
   * Automotive paint system (sample SKUs for system layering UX).
   * These enable the website UI to clearly differentiate Primer/Basecoat/Clearcoat/etc.
   */
  {
    id: 'auto-2k-primer',
    ...
    size: '1 L',
    image: pp('hpc/2K PRIMER+HARDENER.png'),
    gallery: [pp('hpc/2K PRIMER+HARDENER.png')],
    tagline: 'High-adhesion primer stage',
    shortDescription: 'Automotive 2K primer for substrate prep, adhesion, and build.',
    fullDescription: 'A 2K primer designed for automotive refinishing workflows. Use as the foundation layer before basecoat to improve adhesion and surface uniformity.',
    applications: ['Substrate preparation', 'Panel repair', 'Refinishing systems'],
    industries: ['Automotive'],
    specs: { coverage: 'Varies by substrate', dryTime: 'Per TDS', recoatWindow: 'Per TDS', base: '2K system' },
    line: 'automotive',
    chemistry: 'Polyurethane',
    systemStage: 'Primer',
    mixingRatio: '2:1 (Primer:Hardener)',
    tdsUrl: CAPABILITY_PDF_PATH,
    sdsUrl: null,
    featured: false,
  },
  {
    id: 'auto-basecoat-ready-mix',
    name: 'Basecoat Ready Mix',
    size: '1 L',
    image: pp('hpc/BASE COAT READY MIX.png'),
    gallery: [pp('hpc/BASE COAT READY MIX.png')],
    tagline: 'Color layer (basecoat)',
    shortDescription: 'Automotive basecoat for color matching and coverage.',
    fullDescription: 'A ready-mix basecoat intended for the color layer in a standard automotive paint system. Follow with clearcoat for protection and gloss.',
    applications: ['Color layer application', 'Automotive refinishing'],
    industries: ['Automotive'],
    specs: { coverage: 'Per TDS', dryTime: 'Per TDS', recoatWindow: 'Per TDS', base: 'Basecoat system' },
    line: 'automotive',
    chemistry: 'Acrylic',
    systemStage: 'Basecoat',
    mixingRatio: 'Ready mix (per TDS)',
    tdsUrl: CAPABILITY_PDF_PATH,
    sdsUrl: null,
    featured: false,
  },
  {
    id: 'auto-clearcoat-hs',
    name: 'Clearcoat HS',
    size: '5 L',
    image: pp('hpc/CLEAR HS 5 L.png'),
    gallery: [pp('hpc/CLEAR HS 5 L.png')],
    tagline: 'Protection + gloss',
    shortDescription: 'High-solids automotive clearcoat for durability and finish.',
    fullDescription: 'A high-solids clearcoat designed to protect the basecoat and provide gloss and chemical resistance. Pair with the appropriate hardener and thinner per TDS.',
    applications: ['Topcoat protection', 'Gloss finish'],
    industries: ['Automotive'],
    specs: { coverage: 'Per TDS', dryTime: 'Per TDS', recoatWindow: 'Per TDS', base: '2K clearcoat system' },
    line: 'automotive',
    chemistry: 'Polyurethane',
    systemStage: 'Clearcoat',
    mixingRatio: '2:1 + 10% thinner (per TDS)',
    tdsUrl: CAPABILITY_PDF_PATH,
    sdsUrl: null,
    featured: false,
  },
  {
    ...
    name: 'Hardener MS',
    size: '1 L',
    image: pp('hpc/CLEAR + HARDENER MS 1L.png'),
    gallery: [pp('hpc/CLEAR + HARDENER MS 1L.png')],
    tagline: 'Activator for 2K systems',
    shortDescription: 'Hardener for compatible primers/clearcoats in automotive systems.',
    fullDescription: 'A hardener/activator used to cure compatible 2K automotive coatings. Use only with specified products and ratios per TDS.',
    applications: ['2K curing', 'Automotive refinishing'],
    industries: ['Automotive'],
    specs: { coverage: '—', dryTime: 'Per system', recoatWindow: 'Per system', base: 'Activator' },
    line: 'automotive',
    chemistry: 'Polyurethane',
    systemStage: 'Hardener',
    mixingRatio: 'System-dependent (per TDS)',
    tdsUrl: CAPABILITY_PDF_PATH,
    sdsUrl: null,
    featured: false,
  },
  {
    id: 'auto-thinner-special',
    name: 'Thinner Special',
    size: '1 L',
    image: pp('hpc/THINNER SPECIAL.png'),
    gallery: [pp('hpc/THINNER SPECIAL.png')],
    tagline: 'Viscosity control',
    shortDescription: 'Thinner for viscosity adjustment and sprayability (system dependent).',
    fullDescription: 'A thinner designed to adjust viscosity and improve sprayability in compatible automotive coating systems. Follow TDS for recommended percentages and conditions.',
    applications: ['Viscosity adjustment', 'Spray application'],
    industries: ['Automotive'],
    specs: { coverage: '—', dryTime: '—', recoatWindow: '—', base: 'Solvent blend' },
    line: 'automotive',
    chemistry: 'Solvent',
    systemStage: 'Thinner',
    mixingRatio: '5–15% (per TDS)',
    tdsUrl: CAPABILITY_PDF_PATH,
    sdsUrl: null,
    featured: false,
  },
